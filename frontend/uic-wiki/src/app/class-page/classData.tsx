export const classData = [
  ...
  */
  ...
  // 100-level courses
  {
    ...
    professors: ["Baker Franke", "Gonzalo Bello"],
    prof_links: ["https://cs.uic.edu/profiles/franke-baker/", "https://cs.uic.edu/profiles/gonzalo-bello/"],
    credit_hours: 3,
    ...
    difficulty: 4,
    gradeData: [
    { browser: "chrome", visitors: 44.2, fill: "#6050DC" },
    { browser: "safari", visitors: 32.7, fill: "#D52DB7" },
    { browser: "firefox", visitors: 9.7, fill: "#FF2E7E" },
    { browser: "edge", visitors: 3.5, fill: "#FF6B45" },
    { browser: "other", visitors: 9.7, fill: "#FFAB05" },
],
  },
  {
    id: 2,
    ...
    prof_links: ["https://cs.uic.edu/profiles/gu-zhaochen/"],
    credit_hours: 3,
    career_tracks: ["None Specified"],
    prereqs: ["CS 111", "MATH 180 (N/A)"],
    resources: ["N/A"],
    difficulty: 3,
    gradeData: [
    { browser: "chrome", visitors: 44.6, fill: "#6050DC" },
    { browser: "safari", visitors: 28.8, fill: "#D52DB7" },
    { browser: "firefox", visitors: 15.2, fill: "#FF2E7E" },
    { browser: "edge", visitors: 5.4, fill: "#FF6B45" },
    { browser: "other", visitors: 6, fill: "#FFAB05" },
],
  },
  {
    id: 3,
    ...
    prof_links: ["https://cs.uic.edu/profiles/dey-drishika/", "https://cs.uic.edu/profiles/ibrahim-omar/"],
    credit_hours: 3,
    career_tracks: ["None Specified"],
    prereqs: ["CS 111", "MATH 180 (N/A)"],
    resources: ["N/A"],
    difficulty: 2,
    gradeData: [
    { browser: "chrome", visitors: 35.4, fill: "#6050DC" },
    { browser: "safari", visitors: 40.6, fill: "#D52DB7" },
    { browser: "firefox", visitors: 19.2, fill: "#FF2E7E" },
    { browser: "edge", visitors: 3.1, fill: "#FF6B45" },
    { browser: "other", visitors: 1.7, fill: "#FFAB05" },
],
  },
  ...
  //200-level courses - Still need to put in reviews for these
  {
    ...
    prof_links: ["https://cs.uic.edu/profiles/hodges-mark/", "https://cs.uic.edu/profiles/scott-reckinger/"],
    credit_hours: 3,
    career_tracks: ["None Specified"],
    prereqs: ["CS 141"],
    resources: ["N/A"],
    difficulty: 3,
    gradeData: [
    { browser: "chrome", visitors: 27.5, fill: "#6050DC" },
    { browser: "safari", visitors: 28.7, fill: "#D52DB7" },
    { browser: "firefox", visitors: 28.1, fill: "#FF2E7E" },
    { browser: "edge", visitors: 10.5, fill: "#FF6B45" },
    { browser: "other", visitors: 5.3, fill: "#FFAB05" },
],
  },
  {
    id: 5,
    ...
    prof_links: ["https://cs.uic.edu/profiles/ayala-daniel/", "https://cs.uic.edu/profiles/mitchell-theys/"],
    credit_hours: 4,
    career_tracks: ["None Specified"],
    ...
    difficulty: 3,
    gradeData: [
    { browser: "chrome", visitors: 31.5, fill: "#6050DC" },
    { browser: "safari", visitors: 29.2, fill: "#D52DB7" },
    { browser: "firefox", visitors: 23, fill: "#FF2E7E" },
    { browser: "edge", visitors: 11.2, fill: "#FF6B45" },
    { browser: "other", visitors: 5.1, fill: "#FFAB05" },
],
  },
  {
    id: 6,
    ...
    prof_links: ["https://cs.uic.edu/profiles/koehler-adam/"],
    credit_hours: 4,
    career_tracks: ["None Specified"],
    prereqs: ["CS 211"],
    resources: ["N/A"],
    difficulty: 4,
    gradeData: [
    { browser: "chrome", visitors: 28.8, fill: "#6050DC" },
    { browser: "safari", visitors: 39.6, fill: "#D52DB7" },
    { browser: "firefox", visitors: 21.6, fill: "#FF2E7E" },
    { browser: "edge", visitors: 6.8, fill: "#FF6B45" },
    { browser: "other", visitors: 3.2, fill: "#FFAB05" },
],
  },
  {
    id: 7,
    ...
    prof_links: ["https://cs.uic.edu/profiles/carson-jordan/", "https://cs.uic.edu/profiles/cody-cranch/"],
    credit_hours: 3,
    career_tracks: ["None Specified"],
    prereqs: ["CS 141"],
    resources: ["N/A"],
    difficulty: 1,
    gradeData: [
    { browser: "chrome", visitors: 85.9, fill: "#6050DC" },
    { browser: "safari", visitors: 8.9, fill: "#D52DB7" },
    { browser: "firefox", visitors: 5.2, fill: "#FF2E7E" },
],
  },
  //300-level courses
  {
    ...
    prof_links: ["https://cs.uic.edu/profiles/katok-zoa/", "https://cs.uic.edu/profiles/gonzalo-bello/"],
    credit_hours: 4,
    career_tracks: ["None Specified"],
    ...
    difficulty: 3,
    gradeData: [
    { browser: "chrome", visitors: 39.9, fill: "#6050DC" },
    { browser: "safari", visitors: 31, fill: "#D52DB7" },
    { browser: "firefox", visitors: 18.4, fill: "#FF2E7E" },
    { browser: "edge", visitors: 8.2, fill: "#FF6B45" },
    { browser: "other", visitors: 2.4, fill: "#FFAB05" },
],
  },
  {
    id: 9,
    ...
    prof_links: ["https://cs.uic.edu/profiles/shanon-reckinger/"],
    credit_hours: 3,
    career_tracks: ["None Specified"],
    ...
    difficulty: 2,
    gradeData: [
    { browser: "chrome", visitors: 24.7, fill: "#6050DC" },
    { browser: "safari", visitors: 26.6, fill: "#D52DB7" },
    { browser: "firefox", visitors: 27.8, fill: "#FF2E7E" },
    { browser: "edge", visitors: 17.5, fill: "#FF6B45" },
    { browser: "other", visitors: 3.4, fill: "#FFAB05" },
],
  },
  {
    id: 10,
    ...
    prof_links: ["https://cs.uic.edu/profiles/hallenbeck-mark/"],
    credit_hours: 3,
    career_tracks: ["None Specified"],
    prereqs: ["CS 211", "CS 251"],
    resources: ["N/A"],
    difficulty: 3,
    gradeData: [
    { browser: "chrome", visitors: 54.9, fill: "#6050DC" },
    { browser: "safari", visitors: 38.3, fill: "#D52DB7" },
    { browser: "firefox", visitors: 6.4, fill: "#FF2E7E" },
],
  },
  {
    id: 11,
    ...
    prof_links: ["https://cs.uic.edu/profiles/maratos-george-2/"],
    credit_hours: 4,
    career_tracks: ["None Specified"],
    prereqs: ["CS 261"],
    resources: ["N/A"],
    difficulty: 5,
    gradeData: [
    { browser: "chrome", visitors: 30.6, fill: "#6050DC" },
    { browser: "safari", visitors: 36.7, fill: "#D52DB7" },
    { browser: "firefox", visitors: 20.4, fill: "#FF2E7E" },
    { browser: "edge", visitors: 4.1, fill: "#FF6B45" },
    { browser: "other", visitors: 8.2, fill: "#FFAB05" },
],
  },
  {
    id: 12,
    ...
    prof_links: ["https://cs.uic.edu/profiles/evan-mccarty/"],
    credit_hours: 4,
    career_tracks: ["None Specified"],
    prereqs: ["CS 261"],
    resources: ["N/A"],
    difficulty: 2,
    gradeData: [
    { browser: "chrome", visitors: 32.1, fill: "#6050DC" },
    { browser: "safari", visitors: 42.2, fill: "#D52DB7" },
    { browser: "firefox", visitors: 20.3, fill: "#FF2E7E" },
    { browser: "edge", visitors: 3.2, fill: "#FF6B45" },
    { browser: "other", visitors: 2.1, fill: "#FFAB05" },
],
  },
  {
    id: 13,
    ...
    professors: ["Emanuelle Burton", "Kristel Clayville"],
    prof_links: ["https://cs.uic.edu/profiles/emanuelle-burton/", "https://cs.uic.edu/profiles/clayville-kristel/"],
    credit_hours: 3,
    career_tracks: ["None Specified"],
    prereqs: ["CS 251"],
    resources: ["N/A"],
    difficulty: 1,
    gradeData: [
    { browser: "chrome", visitors: 88, fill: "#6050DC" },
    { browser: "safari", visitors: 8, fill: "#D52DB7" },
    { browser: "firefox", visitors: 4, fill: "#FF2E7E" },
],
  },
  ...
  //400-level courses
  {
    ...
    professors: ["Ajay Kshemkalyani", "Bhaskar DasGupta"],
    prof_links: ["https://cs.uic.edu/profiles/ajay-kshemkalyani/", "https://cs.uic.edu/profiles/bhaskar-dasgupta/"],
    credit_hours: 3,
    career_tracks: ["None Specified"],
    prereqs: ["CS 211"],
    resources: ["N/A"],
    difficulty: 5,
    gradeData: [
    { browser: "chrome", visitors: 30, fill: "#6050DC" },
    { browser: "safari", visitors: 43.3, fill: "#D52DB7" },
    { browser: "firefox", visitors: 18.3, fill: "#FF2E7E" },
    { browser: "edge", visitors: 6.7, fill: "#FF6B45" },
    { browser: "other", visitors: 1.7, fill: "#FFAB05" },
],
  },
  {
    ...
    prof_links: ["https://cs.uic.edu/profiles/john-bell/"],
    credit_hours: 0,
    career_tracks: ["None Specified"],
    prereqs: ["N/A"],
    resources: ["N/A"],
    difficulty: 1,
    gradeData: [
    { browser: "chrome", visitors: 100, fill: "#6050DC" },
],
  },
];
