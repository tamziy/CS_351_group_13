...
function FlowchartImage() {
    const [nodes] = useState([
        ...
        { id: '200level', data: { label: '200-Level' }, position: { x: -300, y: 300 }, style: {height: 40, width: 120, backgroundColor: '#D6E4FF', color: 'black', fontSize: 16 }},
        { id: '300level', data: { label: '300-Level' }, position: { x: -300, y: 400 }, style: {height: 40, width: 120, backgroundColor: '#84A9FF', color: 'black', fontSize: 16 }},
        { id: '400level', data: { label: '400-Level' }, position: { x: -300, y: 500 }, style: {height: 40, width: 120, backgroundColor: '#3366FF', color: 'black', fontSize: 16 }},
        ...
        { id: 'cs111', data: { label: (<Link href = "/classes/111"> <span className = "cursor-pointer hover:underline">CS 111</span></Link>) }, position: { x: 200, y: 100 }, style: {height: 40, width: 70, backgroundColor: '#F0F6FF', color: 'black' }},
        { id: 'cs141', data: { label: (<Link href = "/classes/141"> <span className = "cursor-pointer hover:underline">CS 141</span></Link>) }, position: { x: 100, y: 200 }, style: {height: 40, width: 70, backgroundColor: '#F0F6FF', color: 'black' }},
        { id: 'cs151', data: { label: (<Link href = "/classes/151"> <span className = "cursor-pointer hover:underline">CS 151</span></Link>) }, position: { x: 300, y: 200 }, style: {height: 40, width: 70, backgroundColor: '#F0F6FF', color: 'black' }},
        { id: 'cs211', data: { label: (<Link href = "/classes/211"> <span className = "cursor-pointer hover:underline">CS 211</span></Link>) }, position: { x: 50, y: 300 }, style: {height: 40, width: 70, backgroundColor: '#D6E4FF', color: 'black' }},
        { id: 'cs251', data: { label: (<Link href = "/classes/251"> <span className = "cursor-pointer hover:underline">CS 251</span></Link>) }, position: { x: 150, y: 300 }, style: {height: 40, width: 70, backgroundColor: '#D6E4FF', color: 'black' }},
        { id: 'cs261', data: { label: (<Link href = "/classes/261"> <span className = "cursor-pointer hover:underline">CS 261</span></Link>) }, position: { x: 250, y: 300 }, style: {height: 40, width: 70, backgroundColor: '#D6E4FF', color: 'black' }},
        { id: 'cs277', data: { label: (<Link href = "/classes/277"> <span className = "cursor-pointer hover:underline">CS 277</span></Link>) }, position: { x: 350, y: 300 }, style: {height: 40, width: 70, backgroundColor: '#D6E4FF', color: 'black' }},
        { id: 'cs301', data: { label: (<Link href = "/classes/301"> <span className = "cursor-pointer hover:underline">CS 301</span></Link>) }, position: { x: 0, y: 400 }, style: {height: 40, width: 70, backgroundColor: '#84A9FF', color: 'black' }},
        { id: 'cs341', data: { label: (<Link href = "/classes/341"> <span className = "cursor-pointer hover:underline">CS 341</span></Link>) }, position: { x: 100, y: 400 }, style: {height: 40, width: 70, backgroundColor: '#84A9FF', color: 'black' }},
        { id: 'cs342', data: { label: (<Link href = "/classes/342"> <span className = "cursor-pointer hover:underline">CS 342</span></Link>) }, position: { x: 200, y: 400 }, style: {height: 40, width: 70, backgroundColor: '#84A9FF', color: 'black' }},
        { id: 'cs361', data: { label: (<Link href = "/classes/361"> <span className = "cursor-pointer hover:underline">CS 361</span></Link>) }, position: { x: 300, y: 400 }, style: {height: 40, width: 70, backgroundColor: '#84A9FF', color: 'black' }},
        { id: 'cs362', data: { label: (<Link href = "/classes/362"> <span className = "cursor-pointer hover:underline">CS 362</span></Link>) }, position: { x: 400, y: 400 }, style: {height: 40, width: 70, backgroundColor: '#84A9FF', color: 'black' }},
